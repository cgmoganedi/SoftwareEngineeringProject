            ...
            <div class="navbar-brand">
                <span class="navbar-logo">
                    <a href="http://www.wits.ac.za">
                         <img src="assets/images/images-110x169.jpg" alt="Mobirise" title="" style="height: 3.8rem;">
                    </a>
                </span>
                <span class="navbar-caption-wrap"><a class="navbar-caption text-white display-4" href="http://www.wits.ac.za">Job Match</a></span>
            </div>
        </div>
    ...
    <div class="container align-center">
        <div class="row justify-content-md-center">
            <div class="mbr-white col-md-10">
                ...
                <p class="mbr-text pb-3 mbr-fonts-style display-5"><?php echo $usr_bio?></p>
                <div class="mbr-section-btn"><a class="btn btn-md btn-primary-outline display-4" href="http://localhost/JobMatch/src/Students/php/biography_form.php">Edit your bio</a></div>
            </div>
        </div>
    </div>
        ...
        <div class="media-container-row">
            ...
            <div class="card  col-12 col-md-6 col-lg-4">
                ...
                <div class="card-box align-center">
                    ...
                    <div class="mbr-section-btn text-center"><a href="http://localhost/JobMatch/src/Students/php/personal_info_form.php" class="btn btn-secondary display-4">Add/Edit Personal Details</a></div>
                </div>
            </div>
            ...
            <div class="card  col-12 col-md-6 col-lg-4">
                ...
                <div class="card-box align-center">
                    ...
                    <div class="mbr-section-btn text-center"><a href="http://localhost/JobMatch/src/Students/php/academic_info_form.php" class="btn btn-secondary display-4">Add/Edit Academic Information</a></div>
                </div>
            </div>
            ...
            <div class="card  col-12 col-md-6 col-lg-4">
                ...
                <div class="card-box align-center">
                    ...
                    <div class="mbr-section-btn text-center"><a href="http://localhost/JobMatch/src/Students/html/professional_experience.html" class="btn btn-secondary display-4">Add/Edit previous or current experience</a></div>
                </div>
            </div>
			...
			<div class="card  col-12 col-md-6 col-lg-4">
                ...
                <div class="card-box align-center">
                    <h4 class="card-title mbr-fonts-style display-7"><br><br><br>Skills</h4>
                    <p class="mbr-text mbr-fonts-style display-7">Please/Edit insert your current Skills,you might have....<br><br><br></p>
                    <div class="mbr-section-btn text-center"><a href="http://localhost/JobMatch/src/Students/html/skills.html" class="btn btn-secondary display-4">Add/Edit Skills</a></div>
                </div>
            </div>
